...
4. 候補集合内の最低・最高類似度を 0〜1 へ相対化し、全文 45 点、メタデータ 10 点、意味 45 点を上限として合成する
5. 完全一致には 20 点を加え、エラーコードなどの明示検索を保護する

Quick Pick と Language Model Tool の結果には、使用した backend、合計 score、raw cosine、相対score、各成分と Embedding Provider が表示されます。これにより、順位の理由をデバッグできます。
